/**
 * Browser Summary Report Generator
 * 
 * This module generates a server-side rendered browser summary report
...
/**
 * Generate a browser summary report
 ...
 */
async function generateBrowserSummaryReport(processedDataPath, templatePath, outputPath) {
  console.log('STARTING BROWSER SUMMARY REPORT GENERATION');
...
export { generateBrowserSummaryReport };

// Execute the function if this script is run directly
if (import.meta.url === import.meta.main) {
  const args = process.argv.slice(2);
  if (args.length < 3) {
    console.error('Usage: node browser-summary-report-generator.js <processedDataPath> <templatePath> <outputPath>');
    process.exit(1);
  }
  ...
  generateBrowserSummaryReport(processedDataPath, templatePath, outputPath);
}
