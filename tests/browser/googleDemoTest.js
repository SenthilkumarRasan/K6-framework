...
export const options = {
  scenarios: {
    ui: {
      ...
      vus: 10,  // Use 10 VUs for load testing
      iterations: 40,  // Run 200 iterations to collect substantial data
      options: {
        browser: {
          type: 'chromium',
          headless: headless,
  ...
  try {
    ...
    if (page && context) {
      ...
      try { 
        ...
        console.error('[TEST] Error closing browser context:', e.message || 'Unknown error');
      }
    }
  }
}
